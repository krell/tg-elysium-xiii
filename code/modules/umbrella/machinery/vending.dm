/obj/machinery/vending/hydroseeds/umbrella
	name = "\improper MegaSeed Servitor Umbrella Inc."
	desc = "When you need seeds fast!"
	product_slogans = "Umbrella seed provider, we garanty the quality."
	product_ads = "Grow plant to grow the future."
	icon_state = "seeds"
